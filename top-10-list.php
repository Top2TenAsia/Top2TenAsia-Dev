...
<div class="container" style="margin-top: 3ex;">
 ...
 [Top2Ten Asia]</h2>
              ...
              <h3>Check out our top 10 best Korean Dramas on netflix
 </h3>
                <p><i class="fa fa-clock-o"></i> Jul 8, 2021</p> 
			</div>
            </a>
		</div>
 ...
 [Top2Ten Asia]</h2>
              ...
              <h3>Check out our top 10 best Korean Dramas on netflix
                ...
                <p><i class="fa fa-clock-o"></i> Jun 14, 2021</p> 
			</div>
            </a>
		</div>
 ...
 [Top2Ten Asia]</h2>
              ...
              <h3>Check out our top 10 best Korean Dramas of 2018
 </h3>
                <p><i class="fa fa-clock-o"></i> Jun 13, 2021</p> 
			</div>
            </a>
		</div>
		...
		<a href="<?php echo base_path(); ?>/top-10-most-followed-kdrama-actresses-on-instagram.php">
			...
			<h2>
			 TOP 10 MOST FOLLOWED K-DRAMA ACTRESSES ON INSTAGRAM [Top2Ten Asia]</h2>
              ...
              <h3> With the increase in the K-drama fan club there is a recent rise in K-drama stars’ Instagram followers. Here is the top 10 list of actresses who’ve got their new fan base in the recent surge of K-drama love wave.</h3>
		...
		<a href="<?php echo base_path(); ?>/top-10-most-followed-kdrama-actors-on-instagram">
			...
			<h2>
			 TOP 10 MOST FOLLOWED K-DRAMA ACTORS ON INSTAGRAM [Top2Ten Asia]</h2>
              ...
              <h3>These actors are getting too much love and attention from all over the world. Here, we have top 10 actors followed on Instagram. I am sure you must be following most of them if you also love k- dramas. So let’s jump straight to the list.</h3>
		...
		<a href="<?php echo base_path(); ?>/top-10-best-korean-drama-of-2016">
			...
			<h2>
			 Top 10 Best Korean Drama Of 2016 [Top2Ten Asia]</h2>
              ...
              <h3> 2016 is for sure the best year for every Korean Drama fan. In this year we have many legendary dramas whose memories will forever remain in our hearts. This list contains the top 10 gems of 2016 that every Korean Drama fan must watch.</h3>
    ...
    <div class="col-md-7" >
		<a href="<?php echo base_path(); ?>/best-korean-drama-from-each-year">
			...
			<h2>
              ...
              <h3> For every year there can be only one drama that sits on the crown to be called as Drama of the year. This is the list of a masterpiece from every year, containing the top drama of each year from 2010-2020</h3>
